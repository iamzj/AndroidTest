package com.owoh.camera.activity;
        ...
        switch (v.getId()) {
            case R.id.takePicture:
                if (mCamera != null) {
                    ...
                    Toast.makeText(CameraActivity.this, "保存在/sdcard/", Toast.LENGTH_SHORT).show();
//                    mCamera.takePhoto();
                }
